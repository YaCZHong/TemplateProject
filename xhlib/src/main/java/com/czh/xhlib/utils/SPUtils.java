...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = AppConfig.INSTANCE.getApplication().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = AppConfig.INSTANCE.getApplication().getSharedPreferences(spName, mode);
    }
